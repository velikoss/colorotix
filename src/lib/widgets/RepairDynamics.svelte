<script>
    ...
    function getData() {
        ...
        const yearData = repair_expenses_by_month_year[currentYear] || {};
        const aggregated = {};
        ...
        for (let month = 1; month <= 12; month++) {
            ...
            aggregated[monthName] = yearData[monthKey]?.total.toFixed(2) || 0;
        }
...
<div class="hidden md:block col-span-2">
    <MonthYearPickerWide data={repair_expenses_by_month_year} bind:currentMonth bind:currentYear showMonthPicker={false}>
        <div class="w-full h-full flex flex-col relative">
            <div class="absolute text-2xl text-center w-full">Динамика трат на ремонт</div>
            <Bars
...
<div class="block md:hidden col-span-1">
    <MonthYearPicker bind:currentMonth bind:currentYear showMonthPicker={false}>
        <div class="w-full h-full flex flex-col relative">
            <div class="absolute text-2xl text-center w-full">Динамика трат на ремонт</div>
            <Bars
