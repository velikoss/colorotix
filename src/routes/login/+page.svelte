...
>
    <Card style="w-lg h-fit shadow-white/5 text-gray-900 flex-col inter bg-white">
        <img src="https://www.petrolplus.ru/assets/1c2c5e66-a8ac-40ed-9a93-55865669bd85/logo-black.svg">
        ...
        <form onsubmit={handleLogin} class="space-y-4">
            ...
            >
                {loading ? "Заходим..." : "Логин"}
            </button>
            <a class="underline text-sm" href="/register">Нет аккаунта? Зарегистрируйтесь</a>
        </form>
    </Card>
